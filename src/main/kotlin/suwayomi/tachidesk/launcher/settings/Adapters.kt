...
interface Adapter<T> {
    ...
    fun asPropertyValue(value: T): String =
        value?.toString().orEmpty()
}

object BooleanAdapter : Adapter<Boolean> {
    override fun get(settings: ObservableSettings, key: String, default: Boolean) =
    ...
    override fun addListener(settings: ObservableSettings, key: String, default: Boolean, callback: (Boolean) -> Unit) =
        settings.addBooleanListener(key, default, callback)
}

object IntAdapter : Adapter<Int> {
    override fun get(settings: ObservableSettings, key: String, default: Int) =
        settings[key, default]

    override fun set(settings: ObservableSettings, key: String, value: Int) {
        settings[key] = value
    }

    override fun addListener(settings: ObservableSettings, key: String, default: Int, callback: (Int) -> Unit) =
        settings.addIntListener(key, default, callback)
}

object IntOrNullAdapter : Adapter<Int?> {
    override fun get(settings: ObservableSettings, key: String, default: Int?): Int? =
        settings.getIntOrNull(key) ?: default
...
object StringAdapter : Adapter<String> {
    override fun get(settings: ObservableSettings, key: String, default: String) =
        settings[key, default]

    override fun set(settings: ObservableSettings, key: String, value: String) {
        settings[key] = value
    }

    override fun addListener(settings: ObservableSettings, key: String, default: String, callback: (String) -> Unit) =
...
class SerializableAdapter<E>(
    ...
    override fun set(settings: ObservableSettings, key: String, value: E) {
        settings[key] = serialize(value)
    }

    override fun addListener(settings: ObservableSettings, key: String, default: E, callback: (E) -> Unit) =
    ...
    override fun asPropertyValue(value: E): String {
