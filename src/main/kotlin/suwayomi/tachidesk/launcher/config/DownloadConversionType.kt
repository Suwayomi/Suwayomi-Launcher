...
class DownloadConversionType : CustomType {
    override fun parse(
        ...
        return ServerConfig.DownloadConversion(
            target = target,
    ...
    override fun testToConfig(obj: Any): Boolean = obj is ServerConfig.DownloadConversion

    override fun toConfig(
        obj: Any,
        name: String,
    ): Config {
        val conversion = obj as ServerConfig.DownloadConversion
